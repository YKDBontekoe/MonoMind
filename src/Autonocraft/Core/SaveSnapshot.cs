...
{
    /// <summary>
    /// Serializable snapshot passed to WorldSaveManager — decouples saves from AutonocraftGame.
    /// </summary>
    public sealed class SaveSnapshot
    {
        ...
        public int SpawnX { get; init; } = GameConstants.DefaultSpawnX;
        public int SpawnZ { get; init; } = GameConstants.DefaultSpawnZ;
