    ...
    public sealed class VillagerManager
    {
        ...
        public void LoadVillagers(IEnumerable<VillagerSaveData> data)
        {
            ...
            foreach (var entry in data)
            {
                ...
                {
                    villager.SetEquippedTool(ItemStackSaveCodec.Deserialize(entry.EquippedTool));
                }
                ...
                if (entry.Inventory != null)
                {
                    ...
                    {
                        villager.Inventory.SetSlot(i, ItemStackSaveCodec.Deserialize(entry.Inventory[i]));
                    }
                }
        ...
        public List<VillagerSaveData> ExportVillagers()
        {
            ...
            foreach (var villager in _villagers)
            {
                ...
                {
                    inventory.Add(ItemStackSaveCodec.Serialize(villager.Inventory.GetSlot(i)));
                }
                ...
                result.Add(new VillagerSaveData
                {
                    ...
                    EquippedTool = villager.EquippedTool.IsEmpty
                        ? null
                        : ItemStackSaveCodec.Serialize(villager.EquippedTool),
                    Inventory = inventory
                });
            }
