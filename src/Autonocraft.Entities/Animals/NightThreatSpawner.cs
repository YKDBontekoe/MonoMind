...
namespace Autonocraft.Entities
{
    public sealed class NightThreatSpawner
    {
        ...
        private static bool TrySpawnWolfNear(INightThreatPlayer player, VoxelWorld world, AnimalManager animals)
        {
        ...
        public static bool IsPlayerOutside(VoxelWorld world, Vector3 position)
        {
            ...
            const float playerEyeHeight = 1.6f;
            int headY = (int)MathF.Floor(position.Y + playerEyeHeight);
