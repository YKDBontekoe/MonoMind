...
{
    public class BlockInteractionSystem : IBlockInteractionOverlay
    {
        ...
        public static BlockRaycastHit RaycastSolidHit(
            ...
            Vector3 direction,
            float maxDistance) =>
            BlockRaycast.RaycastSolidHit(world, origin, direction, maxDistance);
        ...
        public static BlockRaycastHit RaycastHit(
            ...
            float maxDistance,
            bool solidOnly) =>
            BlockRaycast.RaycastHit(world, origin, direction, maxDistance, solidOnly);
