    ...
    public static class BlockParticleColors
    {
        public static Vector3 GetColor(BlockType type)
        {
            return type switch
            {
                ...
                BlockType.RedSand => new Vector3(0.88f, 0.52f, 0.38f),
                BlockType.Snow => new Vector3(0.92f, 0.94f, 0.98f),
                BlockType.Stone => new Vector3(0.55f, 0.55f, 0.58f),
                BlockType.Dripstone => new Vector3(0.72f, 0.68f, 0.62f),
                ...
                BlockType.OakSapling => new Vector3(0.32f, 0.62f, 0.22f),
                BlockType.BirchSapling => new Vector3(0.42f, 0.68f, 0.30f),
                BlockType.PineSapling => new Vector3(0.28f, 0.52f, 0.24f),
                BlockType.WillowSapling => new Vector3(0.38f, 0.58f, 0.42f),
                BlockType.PalmSapling => new Vector3(0.42f, 0.68f, 0.32f),
                BlockType.CherrySapling => new Vector3(0.88f, 0.42f, 0.52f),
                BlockType.MahoganySapling => new Vector3(0.30f, 0.58f, 0.26f),
                BlockType.MapleSapling => new Vector3(0.82f, 0.38f, 0.22f),
